...
3. There is a third container as well that runs as a *Kubernetes native sidecar container*, reporting number of bytes in and out every 10 seconds from the Pod's network interface (eth0).
